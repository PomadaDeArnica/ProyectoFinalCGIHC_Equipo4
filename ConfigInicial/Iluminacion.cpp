...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Materiales e Iluminacion //Rodríguez Montes de Oca Andrés", nullptr, nullptr);
    ...
    image = stbi_load("Models/Cat_diffuse.jpg", &textureWidth, &textureHeight, &nrChannels, 0);
